...
value ("Camisa", 29.99, "Femenino", "M", 20);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Blusa", 510.99, "Masculino", "P", 10);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Calça", 79.99, "Femenino", "46", 18);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Camisa", 58.99, "Femenino", "G", 2);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Vestido", 35.87, "Femenino", "GG", 15);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Bermuda", 39.99, "Masculino", "M", 14);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Camisa", 34.10, "Femenino", "P", 5);

insert into db_produtos(nome_produto, valor, categoria, tamanho, quantidade)
value ("Vestido", 509.99, "Femenino", "PP", 2);
